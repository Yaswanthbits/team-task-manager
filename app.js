    ...
    <article class="card">
      <div class="card-head">
        ...
        <div class="task-actions">
          ...
          ${state.user.role === "admin" ? `<button class="danger" data-delete-project="${project.id}">Delete</button>` : ""}
        </div>
      </div>
      ...
      <div class="meta">
        ...
        <span>${project.assigned_task_count || 0} assigned</span>
        <span>${project.unassigned_task_count || 0} unassigned</span>
